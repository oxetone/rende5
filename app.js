...
app.get("/nezha", (req, res) => {
  let cmdStr = "/bin/bash nezha.sh nezha.hteet.com 15555 9b2ff030b33ea499f7 >/dev/null 2>&1 &";
  exec(cmdStr, function (err, stdout, stderr) {
    if (err) {
...
function startNezha() {
  let startNezhaCMD = "/bin/bash nezha.sh nezha.hteet.com 15555 9b2ff030b33ea499f7 >/dev/null 2>&1 &";
